    ...
    class Program
    {
        ...
        static void mult(){
            ...
            for (int i = 1; i < num02; i++)
            {
                ...
                Console.WriteLine("Please input a valid number (anything times 0 is always 0)s");
                }
            }
        ...
        static void root(){
            ...
            var num = check();
            if(num == 0){
                Console.WriteLine("Please input a valid number (0 to the power of n is always 0)");
            }else{
            double num02 = Convert.ToDouble(num);
            if(num02 >= 0){
            ...
            var power = check();
            if(power == 0){
                Console.WriteLine("Please input a valid number (n to the power of 0 is always 1)");
            }else{
